...
{
    [CustomPropertyDrawer(typeof(SerializeTypesAttribute))]
    public class SerializeReferenceEditor : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(drawPosition, property, new GUIContent(property.managedReferenceFullTypename), true);
            if (index >= 0)
            {
                if (property.isArray)
                {
